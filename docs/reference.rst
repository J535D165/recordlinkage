...
classified into matches, non=matches and possible matches. Classification
algorithms can be supervised or unsupervised (rougly speaking: with or without
training data). Many of the algorithms need trainings data to classify the
