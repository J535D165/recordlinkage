...
true_matches = 	[(1,2), (2,2), (2,1), (3,2), (5,2), (4,9), (5,6), (6,7), (1,6)]
matches = 		[(1,2), (2,2), (2,1), (5,2), (4,9), (1,6), (9,9), (8,8), (0,8)]

index = pandas.MultiIndex.from_tuples(pairs, names=['first', 'second'])
gold_matches_index = pandas.MultiIndex.from_tuples(true_matches, names=['first', 'second'])
matches_index = pandas.MultiIndex.from_tuples(matches, names=['first', 'second'])
...
class TestMeasures(unittest.TestCase):
	...
	def test_confusion_matrix(self):
		...
		conf_m = recordlinkage.confusion_matrix(gold_matches_index, matches_index, len(index))
		conf_m_2 = recordlinkage.confusion_matrix(gold_matches_index, matches_index, index)
